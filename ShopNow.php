        ...
        <a href="#" class="logo"><i class="fa fa-shopping-basket" aria-hidden="true"></i> Grocery</a>
         <nav>
           ...
           <div class="icons">
              ...
              <div id="cart-btn" > <a href="addToCart.html"> <i class="fa fa-shopping-cart" aria-hidden="true"></i></a></div>
              <div id="user" >  <a href="login.html"><i class="fa fa-user" aria-hidden="true"></i></a> </div>
